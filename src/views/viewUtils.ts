...
export function setBGCol(text: string) : void {
    process.stdout.write(chalk.bgHex('#2e0840')(text));
}

export function showText(text: string, position: number = 1) : void{
...
export function introText(step: number) : void {
...
export function showTextInColumns(textArray: Array<string>, columns: number = 2) {
